...
### Zabbix (Мониторинг)
- **URL**: http://51.250.67.111/zabbix
- **Проверка**: `curl -I http://51.250.67.111`

### Kibana (Визуализация логов)
- **URL**: http://84.252.129.51:5601
...
### External IP адреса:
- **bastion**: 89.169.140.148
- **zabbix**: 51.250.67.111
- **kibana**: 84.252.129.51
